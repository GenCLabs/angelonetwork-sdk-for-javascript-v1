...
bool ECDSACrypto::genKey(const std::string& privateKeyFile, const std::string& publicKeyFile){
    // Private and Public keys
...
bool ECDSACrypto::loadKey(const std::string &privateKeyFile, const std::string &publicKeyFile)
{
  LoadPrivateKey(privateKeyFile, _privateKey);
  LoadPublicKey(publicKeyFile, _publicKey);
  return true;
}
std::string ECDSACrypto::encryptText(const std::string& message){
  return "";
}
std::string ECDSACrypto::decryptText(const std::string& message){
  return "";
}
void ECDSACrypto::encryptFile(const std::string& inputFile, const std::string& outputFile){

}
void ECDSACrypto::decryptFile(const std::string& inputFile, const std::string& outputFile){
